				...
				<table class="table table-hover" style="text-align: center; margin: auto;" >
				  ...
				  <tbody>
						...
						<!--      <td scope="col"  style="width: 20%" id="peopleCnt-${item.airResno}"></td>  탑승인원 -->
						      <td scope="col"  style="width: 20%" id="${item.airResno}"></td> <!-- 탑승인원 -->
						      <td scope="col"  style="width: 20%" id="${item.airResno}-2"></td>  <!--총 결제금액 ajax -->
				<!-- 		  <td scope="col"  style="width: 20%"><span class="badge rounded-pill bg-success">상세내역</span></td>   -->
						      <td scope="col"  style="width: 20%"><button type="button"  class="btn btn-success airResDetailBtn">상세내역</button></td>
						    </tr>
