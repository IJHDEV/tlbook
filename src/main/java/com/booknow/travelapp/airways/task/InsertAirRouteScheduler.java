...
public class InsertAirRouteScheduler {
	...
	private static int insertedTotal;
	...
	public void registerAirRouteAll() {
		...
		System.out.println(insertedTotal +" 행 insert됨");
	...
	private void insertExecution(String[] airportNm) {
		...
		insertedTotal += airRouteService.registerAirRoute(new AirRouteVO(airportNm[0], airportNm[1], depTime), NUMOFROWS);
	}
}